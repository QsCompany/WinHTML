...
exports.decouple = function (node, event, fn) {
...
var Slideout = (function (_super) {
    ...
    Slideout.prototype.StopClosing = function () {
        ...
        this.panel.style.transition = this.panel.style['-webkit-transition'] = this.panel.style[exports.prefix + 'transform'] = this.panel.style.transform = '';
        this._closing = false;
        this._opened = false;
    };
    ...
    */
    Slideout.prototype.close = function () {
        ...
        this._thread = setTimeout(function () {
            self._thread = -1;
            html.className = html.className.replace(/ slideout-open/, '');
            self.panel.style.transition = self.panel.style['-webkit-transition'] = self.panel.style[exports.prefix + 'transform'] = self.panel.style.transform = '';
            self._closing = false;
            self._opened = false;
            self.emit('close');
        }, this._duration + 50);
    ...
    */
    Slideout.prototype._translateXTo = function (translateX) {
        ...
        this.panel.style[exports.prefix + 'transform'] = this.panel.style.transform = 'translate3d(' + translateX + 'px, 0, 0)';
    };
    ...
    */
    Slideout.prototype._setTransition = function () {
        this.panel.style[exports.prefix + 'transition'] = this.panel.style.transition = exports.prefix + 'transform ' + this._duration + 'ms ' + this._fx;
    };
    ...
    */
    Slideout.prototype._initTouchEvents = function () {
        ...
        */
        this._onScrollFn = exports.decouple(doc, 'scroll', function () {
            if (!self._moved) {
        ...
        */
        this._onTouchMoveFn = function (eve) {
            ...
            if (Math.abs(dif_x) > 20) {
                ...
                self.panel.style[exports.prefix + 'transform'] = self.panel.style.transform = 'translate3d(' + translateX + 'px, 0, 0)';
