!function(e){
    if("object" == typeof exports && "undefined" != typeof window.module) window.module.exports = e();
    else if("function" == typeof define && define.amd) define([], e);
    else{
        var f;
        "undefined" != typeof window ? f = window : "undefined" != typeof window.global ? f = window.global : "undefined" != typeof self && (f = self), f.Slideout = e()
    ...
    (function(){
        return (function e(t, n, r){
             ...
             */
                    Slideout.prototype._setTransition = function(){ this.panel.style[prefix + 'transition'] = this.panel.style.transition = prefix + 'transform ' + this._duration + 'ms ' + this._fx; };
                    /**
             ...
             */
                 ...
                 * @param {Function
} listener - A listener function to add.
                 * @returns {Object
} Returns an instance of Emitter.
                 * @example
                 ...
                 * @param {Function
} listener - A listener function to remove.
                 * @returns {Object
} Returns an instance of Emitter.
                 * @example
                 ...
                 */
                        Emitter.prototype.off = function off(event, listener){
                            var listeners;
                            listeners = undefined; // Defines listeners value.
                 ...
                 * @param {...Object
} data - Data to pass to the listeners.
                 * @returns {Object
} Returns an instance of Emitter.
                 * @example
